...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        // selecting USD by default as FROM currency and PEN as TO currency
        let selected = i == 0 ? currency_code == "USD" ? "selected" : "" : currency_code == "PEN" ? "selected" : "";
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/447dd5b005e7214f3c2a7a33/latest/${fromCurrency.value}`;
