...
//Tools
  //Popup
    function toolsbtn() {
    document.getElementById("tools").classList.toggle("toshow");
    }

  //Color Picker
    //Popup
      function cpbtn() {
      document.getElementById("colorp").classList.toggle("cpshow");
      }
    //Slide
      let sindexcp = 1;
      showslidecp(sindexcp);
      function botonslidecp(n) {
        showslidecp(sindexcp += n);
      }
      function currentslidecp(n) {
        showslidecp(sindexcp = n);
      }
      function showslidecp(n) {
        let i;
        let scp = document.getElementsByClassName("slide-colorpicker");
        let dcp = document.getElementsByClassName("dot-colorpicker");
        if (n > scp.length) {sindexcp = 1}    
        if (n < 1) {sindexcp = scp.length}
        for (i = 0; i < scp.length; i++) {
          scp[i].style.display = "none";  
        }
        for (i = 0; i < dcp.length; i++) {
          dcp[i].className = dcp[i].className.replace(" activess", "");
        }
        scp[sindexcp-1].style.display = "block";  
        dcp[sindexcp-1].className += " actives";
      }

  //Color Palette
    //Popup
      function cpabtn() {
      document.getElementById("colorpa").classList.toggle("cpashow");
      }
    //Slide
      let sindexcpa = 1;
      showslidecpa(sindexcpa);
      function botonslidecpa(n) {
        showslidecpa(sindexcpa += n);
      }
      function currentslidecpa(n) {
        showslidecpa(sindexcpa = n);
      }
      function showslidecpa(n) {
        let i;
        let scpa = document.getElementsByClassName("slide-colorpalette");
        let dcpa = document.getElementsByClassName("dot-colorpalette");
        if (n > scpa.length) {sindexcpa = 1}    
        if (n < 1) {sindexcpa = scpa.length}
        for (i = 0; i < scpa.length; i++) {
          scpa[i].style.display = "none";  
        }
        for (i = 0; i < dcpa.length; i++) {
          dcpa[i].className = dcpa[i].className.replace(" activess", "");
        }
        scpa[sindexcpa-1].style.display = "block";  
        dcpa[sindexcpa-1].className += " activess";
      }

  //Canva Draw
    //Popup
      function cdbtn() {
      document.getElementById("canvad").classList.toggle("cdshow");
      }
    //Slide
      let sindexcd = 1;
      showslidecd(sindexcd);
      function botonslidecd(n) {
        showslidecd(sindexcd += n);
      }
      function currentslidecd(n) {
        showslidecd(sindexcd = n);
      }
      function showslidecd(n) {
        let i;
        let scd = document.getElementsByClassName("slide-canvadraw");
        let dcd = document.getElementsByClassName("dot-canvadraw");
        if (n > scd.length) {sindexcd = 1}    
        if (n < 1) {sindexcd = scd.length}
        for (i = 0; i < scd.length; i++) {
          scd[i].style.display = "none";  
        }
        for (i = 0; i < dcd.length; i++) {
          dcd[i].className = dcd[i].className.replace(" actives", "");
        }
        scd[sindexcd-1].style.display = "block";  
        dcd[sindexcd-1].className += " actives";
      }

  //Text Editor
    //Popup
      function tebtn() {
      document.getElementById("texte").classList.toggle("teshow");
      }
    //Slide
      let sindexte = 1;
      showslidete(sindexte);
      function botonslidete(n) {
        showslidete(sindexte += n);
      }
      function currentslidete(n) {
        showslidete(sindexte = n);
      }
      function showslidete(n) {
        let i;
        let ste = document.getElementsByClassName("slide-texteditor");
        let dte = document.getElementsByClassName("dot-texteditor");
        if (n > ste.length) {sindexte = 1}    
        if (n < 1) {sindexte = ste.length}
        for (i = 0; i < ste.length; i++) {
          ste[i].style.display = "none";  
        }
        for (i = 0; i < dte .length; i++) {
          dte [i].className = dte [i].className.replace(" actives", "");
        }
        ste[sindexte-1].style.display = "block";  
        dte [sindexte-1].className += " actives";
      }

  //IDE
    //Popup
      function idebtn() {
      document.getElementById("ide").classList.toggle("ideshow");
      }
    //Slide
      let sindexide = 1;
      showslideide(sindexide);
      function botonslideide(n) {
        showslideide(sindexide += n);
      }
      function currentslideide(n) {
        showslideide(sindexide = n);
      }
      function showslideide(n) {
        let i;
        let side = document.getElementsByClassName("slide-ide");
        let dde = document.getElementsByClassName("dot-ide");
        if (n > side.length) {sindexide = 1}    
        if (n < 1) {sindexide = side.length}
        for (i = 0; i < side.length; i++) {
          side[i].style.display = "none";  
        }
        for (i = 0; i < dde .length; i++) {
          dde [i].className = dde [i].className.replace(" actives", "");
        }
        side[sindexide-1].style.display = "block";  
        dde [sindexide-1].className += " actives";
      }
      
  //Color Tools
    //Popup
      function ctbtn() {
      document.getElementById("colort").classList.toggle("ctshow");
      }
    //Slide
      let sindexct = 1;
      showslidect(sindexct);
      function botonslidect(n) {
        showslidect(sindexct += n);
      }
      function currentslidect(n) {
        showslidect(sindexct = n);
      }
      function showslidect(n) {
        let i;
        let sct = document.getElementsByClassName("slide-colortools");
        let dct = document.getElementsByClassName("dot-colortools");
        if (n > sct.length) {sindexct = 1}    
        if (n < 1) {sindexct = sct.length}
        for (i = 0; i < sct.length; i++) {
          sct[i].style.display = "none";  
        }
        for (i = 0; i < dct .length; i++) {
          dct [i].className = dct [i].className.replace(" actives", "");
        }
        sct[sindexct-1].style.display = "block";  
        dct [sindexct-1].className += " actives";
      }

  //Image Editor
    //Popup
      function iebtn() {
      document.getElementById("imagee").classList.toggle("ieshow");
      }
    //Slide
      let sindexie = 1;
      showslideie(sindexie);
      function botonslideie(n) {
        showslideie(sindexie += n);
      }
      function currentslideie(n) {
        showslideie(sindexie = n);
      }
      function showslideie(n) {
        let i;
        let sie = document.getElementsByClassName("slide-imageeditor");
        let die = document.getElementsByClassName("dot-imageeditor");
        if (n > sie.length) {sindexie = 1}    
        if (n < 1) {sindexie = sie.length}
        for (i = 0; i < sie.length; i++) {
          sie[i].style.display = "none";  
        }
        for (i = 0; i < die .length; i++) {
          die [i].className = die [i].className.replace(" actives", "");
        }
        sie[sindexie-1].style.display = "block";  
        die [sindexie-1].className += " actives";
      }

  //Pixel Art
    //Popup
      function pabtn() {
      document.getElementById("pixela").classList.toggle("pashow");
      }
    //Slide
      let sindexpa = 1;
      showslidepa(sindexpa);
      function botonslidepa(n) {
        showslidepa(sindexpa += n);
      }
      function currentslidepa(n) {
        showslidepa(sindexpa = n);
      }
      function showslidepa(n) {
        let i;
        let spa = document.getElementsByClassName("slide-pixelart");
        let dpa = document.getElementsByClassName("dot-pixelart");
        if (n > spa.length) {sindexpa = 1}    
        if (n < 1) {sindexpa = spa.length}
        for (i = 0; i < spa.length; i++) {
          spa[i].style.display = "none";  
        }
        for (i = 0; i < dpa .length; i++) {
          dpa [i].className = dpa [i].className.replace(" actives", "");
        }
        spa[sindexpa-1].style.display = "block";  
        dpa [sindexpa-1].className += " actives";
      }

  //Password Generator
    //Popup
      function pgbtn() {
      document.getElementById("passwordg").classList.toggle("pgshow");
      }
    //Slide
      let sindexpg = 1;
      showslidepg(sindexpg);
      function botonslidepg(n) {
        showslidepg(sindexpg += n);
      }
      function currentslidepg(n) {
        showslidepg(sindexpg = n);
      }
      function showslidepg(n) {
        let i;
        let spg = document.getElementsByClassName("slide-passwordgenerator");
        let dpg = document.getElementsByClassName("dot-passwordgenerator");
        if (n > spg.length) {sindexpg = 1}    
        if (n < 1) {sindexpg = spg.length}
        for (i = 0; i < spg.length; i++) {
          spg[i].style.display = "none";  
        }
        for (i = 0; i < dpg .length; i++) {
          dpg [i].className = dpg [i].className.replace(" actives", "");
        }
        spg[sindexpg-1].style.display = "block";  
        dpg [sindexpg-1].className += " actives";
      }

  //Dev Tools
    //Popup
      function dtbtn() {
      document.getElementById("devt").classList.toggle("dtshow");
      }
    //Slide
      let sindexdt = 1;
      showslidedt(sindexdt);
      function botonslidedt(n) {
        showslidedt(sindexdt += n);
      }
      function currentslidedt(n) {
        showslidedt(sindexdt = n);
      }
      function showslidedt(n) {
        let i;
        let sdt = document.getElementsByClassName("slide-devtools");
        let ddt = document.getElementsByClassName("dot-devtools");
        if (n > sdt.length) {sindexdt = 1}    
        if (n < 1) {sindexdt = sdt.length}
        for (i = 0; i < sdt.length; i++) {
          sdt[i].style.display = "none";  
        }
        for (i = 0; i < ddt .length; i++) {
          ddt [i].className = ddt [i].className.replace(" actives", "");
        }
        sdt[sindexdt-1].style.display = "block";  
        ddt [sindexdt-1].className += " actives";
      }

//Notes
  //Popup
    function notesbtn() {
    document.getElementById("notes").classList.toggle("nshow");
    }
  //App
